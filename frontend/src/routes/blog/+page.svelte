<div class="min-h-screen p-8 max-w-2xl mx-auto">
  ...
  <div class="flex flex-col gap-6">
    ...
    <article>
      ...
      <p class="text-sm leading-relaxed mb-4">
        For the most part, I opted for a minimal design since Polywatcher is an internal tool for investigators and journalists. Something that sits on a Slack channel in the newsroom. The analysis was colour-coded to make it easier to assess risk at a glance, but the raw JSON output is also available for those who would rather do their own analysis. An info section was added so users could easily understand what each metric meant and how it was calculated.
      </p>
      <figure class="my-6">
